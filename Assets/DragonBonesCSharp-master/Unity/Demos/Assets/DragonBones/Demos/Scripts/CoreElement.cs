...
public class Mecha
{
    ...
    private void _UpdateAnimation()
    {
        ...
        {
            this._speedX = 0;
            this._armature.animation.FadeIn("squat", -1.0f, -1, 0).resetToPose = false;
        ...
        {
            this._speedX = 0;
            this._armature.animation.FadeIn("idle", -1.0f, -1, 0).resetToPose = false;
            this._walkState = null;
        }
        else
        {
            ...
            {
                this._walkState = this._armature.animation.FadeIn("walk", -1.0f, -1, 0 );
    ...
    private void _Fire(Vector3 firePoint)
    {
        ...
        var bulletComonponnet = bulletArmatureComonponnet.gameObject.AddComponent<Bullet1>();
